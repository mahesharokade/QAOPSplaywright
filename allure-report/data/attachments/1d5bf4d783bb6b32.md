...
- Name: ClientAppOtherway.spec.js >> Client app login
...
Call log:
  - waiting for getByRole('button', { name: 'India' }).nth(1)
    - locator resolved to <button type="button" _ngcontent-lne-c37="" class="ta-item list-group-item ng-star-inserted">…</button>
