...
- Name: exceljsdemo.spec.js >> test upload download excel validation
- Location: tests\exceljsdemo.spec.js:36:1
...
Call log:
  ...
  - waiting for getByRole('row').filter({ has: getByText('Mango') }).locator('#cell-4-undefined')
    8 × locator resolved to <div role="cell" data-column-id="4" id="cell-4-undefined" data-tag="allowRowEvents" class="sc-hLQSwg sc-eDLKkx sc-jTQCzO kyDEvf gfKXFa cJTPDY rdt_TableCell">…</div>
...
```ts
  ...
  21 |             //console.log(cell.value);
  22 | 
  23 |             if (cell.value === searchText) {
  24 |                 console.log(rowNumber);
  25 |                 console.log(colNumber);
  26 |                 output.row = rowNumber;
  27 |                 output.column = colNumber;
  28 | 
  29 | 
  30 |             }
  31 |         })
  ...
  33 |     return output;
  34 | }
  35 | //writeexcelTest("Mango", 350,{rowchange:0,colchange:2}, "C:/work/download.xlsx");
  36 | test('test upload download excel validation',async ({page})=>
  37 | {
  38 |     const textSearch = 'Mango';
  39 |   const updateValue = '350';
  ...
  44 |     writeexcelTest(textSearch, updateValue,{rowchange:0,colchange:2}, "C:/Users/Mahesh/Downloads/download.xlsx");
  45 |     await page.locator("#fileinput").click();
  46 |     await page.locator("#fileinput").setInputFiles("C:/Users/Mahesh/Downloads/download.xlsx")
